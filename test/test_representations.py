...
class DB_Tests(unittest.TestCase):
    ...
    def setUp(self):
        """
        We first have to set up a container object based on our chosen crystal and orientation family
        """
    ...
    def test_gop(self):
        # ToDo - modify after modifying states.
        dblist = []
        dblist.append(db1)
        for g in crys.G:
